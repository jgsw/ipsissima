...
<!-- Project Gutenberg apparatus (header and licence, 3241 words) cut 14 Sep 2026
     by the converter's creation-time rule -- the pamphlet is public domain, and
     PG's terms allow the text stripped of PG references, or the ebook whole,
     never their branding without their licence. Provenance: this folder's README
     (Project Gutenberg e-text #1080). -->
