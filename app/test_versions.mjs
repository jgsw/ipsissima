/** One release, one version number — stated in five files that nothing keeps in step.
 *
 ...
 *  Five places is four chances to bump some and not others, and every one of the resulting
...
if (versions.length !== 1)
  console.log(`\n  ${versions.length} different versions in play: ${versions.join(", ")}` +
              "\n  A release is one version. Bump all five, or none.");
